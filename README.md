...
Advisor for Aicountly — a React single-page app built with Vite and TypeScript,
with a small PHP API alongside it. Both halves deploy to cPanel.

| Environment | App | API |
| --- | --- | --- |
| Production | https://advisor.aicountly.com | https://advisor.aicountly.com/api |
| Sandbox | https://advisor.gh.aicountly.com | https://advisor.gh.aicountly.com/api |
...
(`https://advisor.gh.aicountly.com/api`) so the token exchange has somewhere to
