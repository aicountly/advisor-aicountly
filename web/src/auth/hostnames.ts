 ...
 * advisor.aicountly.com and advisor.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'advisor').trim() || 'advisor'
...
/**
 * `advisor.aicountly.com` and `advisor.gh.aicountly.com` both resolve to
 * `advisor`, which is what the portal expects in authentication_jump.
 */
